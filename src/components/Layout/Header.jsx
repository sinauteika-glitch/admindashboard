      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:block">
            ...
            <p className="text-slate-800 dark:text-slate-400">
              Selamat datang, Agus Suliyanto! bagaimana kabarnya hari ini?
            </p>
          </div>
        </div>
        ...
        <div className="flex-1 max-w-md mx-8">
          <div className="relative">
            ...
            />
            <button className="absolute right-2 top-1/2 transform -translate-y-1/2 p-1.5 text-slate-400 hover:text-slate dark:hover:text-slate-300">
              <Filter />
            </button>
          </div>
        </div>
